class Cuadricula
	...
	def posiciones_de_x_y_de_las_lineas(tamano_lienzo, tamano_cuadricula)
		tamano_linea = tamano_de_las_lineas(tamano_cuadricula,tamano_lienzo)
		...
		posiciones = Array.new(1) {Array.new(["linea", "Xinicial", "Yinicial", "Xfinal", "Yfinal"])}
		i = 1
		cantidad_lineas = Integer(cantidad_de_lineas(tamano_cuadricula))
		while i < Integer(cantidad_lineas)  do
			posiciones.push(Array.new(["#{i}", "0", "0", "#{tamano_linea}", "0"]))
		  i +=1
		end
